...
//    final static float INERCIA_MAXIMA = (float) 0.9;
    static float ACELERACION_MINIMA;
    static float ACELERACION_MAXIMA;
    static float INERCIA_MINIMA;
    static float INERCIA_MAXIMA;
    ...
    public Enjambre(int cantidadParticulas, float aMin, float aMax, float inMin, float inMax, boolean velocidadAleatoria) {
        ACELERACION_MINIMA = aMin;
        ACELERACION_MAXIMA = aMax;
        INERCIA_MAXIMA = inMax;
        INERCIA_MINIMA = inMin;
    ...
    private void generarVelocidadesAleatorias() {
        Random random = new Random();
        for (Particula i : particulas) {
            i.setVelocidadX(random.nextInt(RANGO_NUMEROS_ALEATORIOS));
            i.setVelocidadY(random.nextInt(RANGO_NUMEROS_ALEATORIOS));
        }
    }
